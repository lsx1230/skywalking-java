...
package com.znlh.zapm.plugin.forkjoin.define;
...
public class ForkJoinPoolExecutorInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String INTERCEPT_EXECUTE_METHOD_HANDLE = "com.znlh.zapm.plugin.forkjoin.ForkJoinPoolExecuteMethodInterceptor";

    private static final String INTERCEPT_SUBMIT_METHOD_HANDLE = "com.znlh.zapm.plugin.forkjoin.ForkJoinPoolSubmitMethodInterceptor";
